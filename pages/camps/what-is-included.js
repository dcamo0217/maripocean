                ...
                <div className={styles.campsContent}>
                    ...
                    <div className={styles.campsText}>
                        <ul>
                            ...
                            <li>
                                Solo travellers will be matched with a roommate
                            </li>
                            <li>
                                3 semi-private surf, kitesurf and wingfoil
                                lessons with certified IKO and ISA coaches and
                                equipment (+12 years of experience)
                            </li>
                            <li>
                                All deliciously caribbean fresh meals per day
                                plus daily healthy snacks and hydration
                                (breakfast, lunch and dinner with vegetarian
                                options)
                            </li>
                            <li>Daily restorative yoga and meditation</li>

                            <li>
                                Fun professional photos from all the experience
                            </li>
                            <li>
                                All transfers airport-hotel and between
                                activities
                            </li>
                            <li>
                                Additional fun trips to secret local tourism
